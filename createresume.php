<?php
$title = " Create Resumes | Resume Maker";
        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" placeholder="Web Developer Consultant" name="resume_title"  value="resume<?=time()?>" class="form-control">
                    </div>
                <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>

                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input type="text" placeholder="Harman" name="full_name" class="form-control">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" name="mobile_no" 
