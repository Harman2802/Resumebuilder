...
if($_POST){
 ...
 if($post['your_name'] && $post['email_id'] && $post['password']){
   ...
   if($result['user']){
    ...
    try
  {
    $db->query("INSERT INTO users(your_name,email_id,password) VALUES('$your_name','$email_id','$password')");
    $fn->setAlert('You are Enter Successfully !'); 
