<?php
$title = "Change Password | Resume Maker";
        ...
        <main class="form-signin w-100 m-auto bg-white shadow rounded">
            <form method="post" action="actions/changepassword.action.php">
                <div class="d-flex gap-2 justify-content-center">
                    <img class="mb-4" src="./assest/images/logo.png" alt="" height="70">
                ...
                <div class="mb-3">
                    <span class="mb-3 fw-bold"><?=$fn->getSession('email')==''?$fn->redirect('forgor-password.php'):$fn->getSession('email')?></span>
                </div>
