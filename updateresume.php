    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <form aaction="actions/createresume.action.php" method="post" class="row g-3 p-3">
                <div class="col-md-6">
                        <label class="form-label">Resume Title</label>
                        <input type="text" placeholder="Web Developer Consultant" name="resume_title"  value="<?=@$resume['resume_title']?>"  class="form-control">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" placeholder="Your Name" value="<?=@$resume['full_name']?>"  class="form-control">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" placeholder="mail@abc.com" value="<?=@$resume['email_id']?>"  class="form-control" required>
                    </div>
...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                   If you have a Experience, you can add it 
                                </p>
...
<div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                   If you have a Education, you can add it 
                                </p>
            ...
            <div class="modal-body">
                <form method="post" action="actions/addexperience.action.php" class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="position" placeholder="e.g., Web Developer (2+ years)" id="position" required>
                    </div>
                    <div class="col-12">
                        <label for="company" class="form-label">Company</label>
                        <input type="text" class="form-control" name="company" placeholder="e.g., KFC, Ludhiana" id="company" required>
                    </div>
                    <div class="col-md-6">
                        <label for="started" class="form-label">Joined</label>
                        <input type="text" name="started" class="form-control" id="started" required>
                    </div>
                    <div class="col-md-6">
                        <label for="ended" class="form-label">Resigned</label>
                        <input type="text" name="ended" class="form-control" id="ended" required>
                    </div>
                    <div class="col-12">
                        <label for="job_desc" class="form-label">Job Description</label>
                        <textarea class="form-control" name="job_desc" id="job_desc" rows="4" required></textarea>
                    </div>
                    <div class="col-12 text-end">
...
<div class="modal fade" id="addedu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <input type="text" class="form-control" name="institute" placeholder="PSEB" id="inputPassword4" required>
  </div>

  <div class="col-12">
    <label for="inputEmail4" class="form-label">Course / Degree</label>
    <input type="text" class="form-control" name="course" placeholder="Completed +2 class (Science Stream)" id="inputEmail4" required>
  </div>

  
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Started</label>
    <input type="text" name="started" placeholder="March 2023" class="form-control" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
...
<div class="modal fade" id="addskill" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <input type="text" class="form-control" name="skill" placeholder="Basic Knowledge in Computer" id="inputPassword4" required>
  </div>
